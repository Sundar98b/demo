...
/* prettier-ignore */
const Application        =  lazy(() =>  retry(() => import("./application")));
...
const Settings: React.FC<RouteComponentProps> = ({ match }) => {
  ...
  useEffect(() => {
    let name = location.pathname.replace("/settings/", "");
  ...
  return (
    <>
      <RootPage sidebar="Settings">
        <Rolecheck module="Settings Menu" fullpage>
          <Row>
            {hideSidebar && (
            ...
            >
              ...
              {hideSidebar && (
                <ContentWarpper>
                  ...
                  <Route path="/settings/application" component={Application} />
                  <Route path="/settings/organization-setup" component={OrganizationSetup} />
